...
# Copyright (c) CrowdStrike, Inc. 2022-2023. All rights reserved.
...
version_current=${version_3_11_1} && version_current_date=${version_3_11_1_date}
...
um_telemetry_file=/var/log/falcon-cstel_um.log
km_telemetry_file=/var/log/falcon-cstel_km.log
wait_time=0
done=0
